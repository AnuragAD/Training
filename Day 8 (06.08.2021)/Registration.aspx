          ...
          <form id="form1" runat="server">
                    ...
                    <div class="form-group">
                         <asp:Label ID="Label4" runat="server" Text="Label">Age</asp:Label> 
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                          <asp:TextBox ID="TextBox3" runat="server" TextMode="Number" required="true"></asp:TextBox>
                      </div><br />
                    <div class="form-group">
                         <asp:Label ID="Label5" runat="server" Text="Label">Email Id</asp:Label> 
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                          <asp:TextBox ID="TextBox4" runat="server" TextMode="Email" required="true"></asp:TextBox>
                      </div><br /> 
                <div class="form-group">
                         <asp:Label ID="Label7" runat="server" Text="Label" required="true">Pincode</asp:Label> 
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                          <asp:TextBox ID="TextBox5" runat="server" TextMode="Number" MaxLength="6" MinLength="6" required="true" ></asp:TextBox>
                      </div><br /> 
                <div class="form-group">
                         <asp:Label ID="Label8" runat="server" Text="Label">Password</asp:Label> 
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                          <asp:TextBox ID="TextBox6" runat="server" TextMode="Password" required="true"></asp:TextBox>
                </div><br /> 
                <div class="form-group">
                         <asp:Label ID="Label9" runat="server" Text="Label" >Confirm Password</asp:Label> 
                          &nbsp;&nbsp;&nbsp;&nbsp; 
                          <asp:TextBox ID="TextBox7" runat="server" TextMode="Password" required="true" ></asp:TextBox>
                </div><br /> 
                <div class="form-group">
